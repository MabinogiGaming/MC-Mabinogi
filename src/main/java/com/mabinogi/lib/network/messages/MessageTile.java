...
public class MessageTile extends MessageBase implements IMessage, IMessageHandler<MessageTile, IMessage> {
	...
	public MessageTile(TileEntity tile) 
	{
	...
	public IMessage onMessage(MessageTile message, MessageContext ctx) 
	{
		...
		{
			((TileBase) tileEntity).readMessageTile(message.nbt);
